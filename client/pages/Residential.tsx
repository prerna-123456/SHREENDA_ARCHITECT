...
export default function Residential() {
  ...
  const residentialProjects = [
    { image: "/ResidentialProject1.png", alt: "Modern contemporary house with car" },
    { image: "/ResidentialProject2.png", alt: "Classic white luxury villa" },
  ];

  const gridProjects = [
    { image: "/ResidentialProject4.png", alt: "Modern house with car night view" },
    { image: "/ResidentialProject5.png", alt: "Contemporary multi storey elevation night" },
    { image: "/ResidentialProject6.png", alt: "Modern apartment building night view" },
    { image: "/ResidentialProject7.png", alt: "Classic white villa with garden" },
  ];
      ...
      <section className="bg-black text-white">
        ...
        <div className="relative w-full h-[369px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center animate-slideInTogether">
            <h1 className="text-[40px] font-inter font-bold text-white tracking-wide mt-10">Residential</h1>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div style={{ maxWidth: "500px" }} className={`mb-10 ${visible1 ? "animate-fadeLeft" : "opacity-0"}`}>
          ...
          <p className="text-[#B7B7B7] text-[16px] font-inter leading-relaxed">
            Thoughtfully planned homes designed around everyday living,
            where comfort, functionality, and a sense of belonging come
