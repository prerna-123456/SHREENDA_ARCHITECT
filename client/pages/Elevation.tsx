...
export default function Residential() {
  ...
  const residentialProjects = [
    { image: "/ElevationProject1.png", alt: "Modern contemporary house with car" },
    { image: "/ElevationProject2.png", alt: "Classic white luxury villa" },
  ];

  const gridProjects = [
    { image: "/ElevationProject4.png", alt: "Modern house with car night view" },
    { image: "/ElevationProject5.png", alt: "Contemporary multi storey elevation night" },
    { image: "/ElevationProject6.png", alt: "Modern apartment building night view" },
    { image: "/ElevationProject7.png", alt: "Classic white villa with garden" },
  ];
      ...
      <section className="bg-black text-white">
        ...
        <div className="relative w-full h-[369px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-[40px] font-inter font-bold text-white tracking-wide mt-10 animate-slideInTogether">Elevation</h1>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div style={{ maxWidth: "500px" }} className={`mb-10 ${visible1 ? "animate-fadeLeft" : "opacity-0"}`}>
          <h2 className="text-white text-[22px] font-medium font-inter mb-3">
            Explore our Elevation Projects
          </h2>
          <p className="text-[#B7B7B7] text-[16px] font-inter leading-relaxed">
            Exteriors that leave a lasting impression, designed to express
            character and create a strong architectural presence from the
            very first glance.
          </p>
        </div>
