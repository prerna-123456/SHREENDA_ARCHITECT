...
export default function Commercial() {
  ...
  const residentialProjects = [
    { image: "/CommercialProject1.png", alt: "Modern contemporary house with car" },
    { image: "/CommercialProject2.png", alt: "Classic white luxury villa" },
  ];

  const gridProjects = [
    { image: "/CommercialProject4.png", alt: "Modern house with car night view" },
    { image: "/CommercialProject5.png", alt: "Contemporary multi storey elevation night" },
    { image: "/CommercialProject6.png", alt: "Modern apartment building night view" },
    { image: "/CommercialProject7.png", alt: "Classic white villa with garden" },
  ];

  const residentialProjects1 = [
    { image: "/CommercialProject9.png", alt: "Modern contemporary house with car" },
    { image: "/CommercialProject10.png", alt: "Classic white luxury villa" },
  ];
      ...
      <section className="bg-black text-white">
        ...
        <div className="relative w-full h-[369px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center animate-slideInTogether">
            <h1 className="text-[40px] font-inter font-bold text-white tracking-wide mt-10">Commercial</h1>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div style={{ maxWidth: "500px" }} className={`mb-10 ${visible1 ? "animate-fadeLeft" : "opacity-0"}`}>
          ...
          <p className="text-[#B7B7B7] text-[16px] font-inter leading-relaxed">
            Purpose-driven spaces that balance practicality with strong
            visual identity, creating environments that support growth,
          ...
          {residentialProjects1.map((project, index) => (
            <div key={index} style={{ overflow: "hidden" }}>
              <img
                src={project.image}
                alt={project.alt}
                className={`w-full h-[501px] object-cover hover:scale-105 transition-transform duration-300 ${visible5 ? "animate-fadeUp" : "opacity-0"}`}
              />
            </div>
          ))}
        </div>
