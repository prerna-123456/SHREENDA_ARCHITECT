...
export default function Interior() {
  ...
  const residentialProjects = [
    { image: "/InteriorProject17.JPG", alt: "Modern contemporary house with car" },
    { image: "/InteriorProject18.jpg", alt: "Classic white luxury villa" },
  ];

  const gridProjects = [
    { image: "/InteriorProject4.png", alt: "Modern house with car night view" },
    { image: "/InteriorProject14.jpg", alt: "Contemporary multi storey elevation night" },
    { image: "/InteriorProject15.jpg", alt: "Modern apartment building night view" },
    { image: "/InteriorProject16.jpg", alt: "Classic white villa with garden" },
  ];

  const residentialProjects1 = [
    { image: "/InteriorProject9.png", alt: "Modern contemporary house with car" },
    { image: "/InteriorProject10.png", alt: "Classic white luxury villa" },
    { image: "/InteriorProject11.png", alt: "Classic white luxury villa" },
    { image: "/InteriorProject12.png", alt: "Classic white luxury villa" },
  ];
    ...
    <div className="bg-black">
      <section className="bg-black text-white">
        ...
        <div className="relative w-full h-[369px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-[40px] font-inter font-bold text-white tracking-wide mt-10 animate-slideInTogether">Interior</h1>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div style={{ maxWidth: "500px" }} className={`mb-10 ${visible1 ? "animate-fadeLeft" : "opacity-0"}`}>
          ...
          <p className="text-[#B7B7B7] text-[16px] font-inter leading-relaxed">
            Spaces shaped from within, where textures, light, and layout
            work together to create an atmosphere that feels both refined
            and intuitive.
          </p>
        </div>
          ...
          {residentialProjects.map((project, index) => (
            <div key={index} style={{ overflow: "hidden" }}>
              <img
                src={project.image}
                alt={project.alt}
                className={`w-full h-[501px] object-cover hover:scale-105 transition-transform duration-300 ${visible1 ? "animate-fadeUp" : "opacity-0"}`}
              />
            </div>
          ))}
        </div>
      ...
      >
        <div style={{ overflow: "hidden" }}>
          <img
            src="/InteriorProject19.jpg"
            alt="Pawar Residence modern house elevation"
            className={`w-full h-[565px] object-cover hover:scale-105 transition-transform duration-300 ${visible2 ? "animate-slideInTogether" : "opacity-0"}`}
          />
        </div>
      </section>
          ...
          {gridProjects.map((project, index) => (
            <div key={index} style={{ overflow: "hidden" }}>
              <img
                src={project.image}
                alt={project.alt}
                className={`w-full h-[501px] object-cover hover:scale-105 transition-transform duration-300 ${visible3 ? "animate-slideInTogether" : "opacity-0"}`}
              />
            </div>
          ))}
        </div>
      ...
      <section
        ref={sectionRef4}
        className="bg-black pt-3 pb-12"
        style={{ fontFamily: "'Inter', sans-serif", paddingLeft: "123px", paddingRight: "123px" }}
      >
        <div style={{ overflow: "hidden" }}>
          <img
            src="/InteriorProject13.jpg"
            alt="Pawar Residence modern house elevation"
            className={`w-full h-[664px] object-cover hover:scale-105 transition-transform duration-300 ${visible4 ? "animate-fadeUp" : "opacity-0"}`}
          />
        </div>
      </section>
      ...
      >
        ...
        >
          {residentialProjects1.map((project, index) => (
            <div key={index} style={{ overflow: "hidden" }}>
              <img
                src={project.image}
                alt={project.alt}
                className={`w-full h-[501px] object-cover hover:scale-105 transition-transform duration-300 ${visible5 ? "animate-slideInTogether" : "opacity-0"}`}
              />
            </div>
          ))}
        </div>
